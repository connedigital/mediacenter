...
hash mono 2>/dev/null || wget https://raw.githubusercontent.com/connedigital/mediacenter/master/mono-project/mono-install.sh -O - -o /dev/null|bash
...
Type=simple
User=$user
ExecStart=/usr/bin/mono Radarr.exe --nobrowser
Restart=always
RestartSec=2
TimeoutStopSec=5
